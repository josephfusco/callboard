...
- `blueprint.json` and the README badge load the plugin zip and demo audio from the Pages site, not the repository, so Playground works while the repository is private.
