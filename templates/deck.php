	...
	<div class="deck-inner">
		...
		<div class="deck-row">
			<div class="deck-text">
				...
				<span class="deck-time" data-offline="<?php esc_attr_e( 'Offline', 'callboard' ); ?>"><span id="cur">0:00</span><span class="sep" aria-hidden="true"> / </span><span id="dur">0:00</span><button type="button" class="loop-chip" id="loop" data-state="" aria-label="<?php esc_attr_e( 'Set a loop: tap at the start, then at the end', 'callboard' ); ?>"><?php esc_html_e( 'Loop', 'callboard' ); ?></button><button type="button" class="rate-chip" id="rate" data-state="" aria-label="<?php esc_attr_e( 'Playback speed 1×, tap to slow down', 'callboard' ); ?>">1×</button></span>
			</div>
